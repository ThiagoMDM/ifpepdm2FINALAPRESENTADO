...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? RestaurantesWidget() : LoginWidget(),
      routes: [
        Route(
          name: '_initialize',
          path: '/',
        ...
        Route(
          ...
          builder: (context, params) => ProdutosWidget(
            refrestaurantes: params.getParam('refrestaurantes',
        ...
        Route(
          name: 'detalhesprod',
          path: '/detalhesprod',
          builder: (context, params) => DetalhesprodWidget(
            refprodutos: params.getParam('refprodutos',
                ParamType.DocumentReference, false, ['restaurantes', 'pratos']),
          ),
        ),
        Route(
          name: 'carrinho',
