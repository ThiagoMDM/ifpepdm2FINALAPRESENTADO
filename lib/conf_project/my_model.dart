...
Widget wrapWithModel<T extends ProjectModel>({
  required T model,
...
T createModel<T extends ProjectModel>(
...
class ProjectDynamicModels<T extends ProjectModel> {
  ProjectDynamicModels(this.defaultBuilder);
